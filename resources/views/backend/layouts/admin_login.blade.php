...
<head>
    ...
    <link href="{{ URL::asset('resources/assets/backend/css/demo1/pages/login/login-4.css') }}" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="{{ URL::asset('resources/assets/backend/css/demo1/skins/header/base/light.css') }}" rel="stylesheet"
          type="text/css"/>
    <link href="{{ URL::asset('resources/assets/backend/css/demo1/skins/header/menu/light.css') }}" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="{{ URL::asset('resources/assets/backend/css/demo1/skins/aside/dark.css') }}" rel="stylesheet"
          type="text/css"/>
    <!--end::Layout Skins -->
    <link href="{{ URL::asset('resources/assets/backend/css/custom-auth.css') }}" rel="stylesheet"
          type="text/css"/>
</head>
<!-- end::Head -->
<!-- begin::Body -->
...
<div class="kt-grid kt-grid--ver kt-grid--root">
    <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v4 kt-login--signin" id="kt_login">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor"
             style="background-image: url({{ URL::asset('resources/assets/backend/media/bg/bg-2.jpg') }});">
            <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                <div class="kt-login__container">
                    <div class="kt-login__logo">
                        <a href="#">
                            <img src="{{ URL::asset('resources/files/uploads/logos/logo-admin-login.png') }}" alt="logo"
                                 class="logo-default"/>
                        </a>
                    </div>
                    @yield('content')
...
<script src="{{ URL::asset('resources/assets/backend/js/demo1/pages/login/login-general.js') }}"
        type="text/javascript"></script>
<!--end::Page Scripts -->
