@if(Session::has('message'))
    <div class="alert alert-success" role="alert">
        <div class="alert-icon"><strong><i class="fa fa-check-circle" style="font-size: 15px;"></i></strong>
        </div>
...
@if(Session::has('error_message'))
    <div class="alert alert-danger" role="alert">
        <div class="alert-icon"><strong><i class="fa fa-times-circle" style="font-size: 15px;"></i></strong>
        </div>
...
@if(Session::has('warning_message'))
    <div class="alert alert-warning" role="alert">
        <div class="alert-icon"><strong><i class="fa fa-info-circle" style="font-size: 15px;"></i>!</strong></div>
