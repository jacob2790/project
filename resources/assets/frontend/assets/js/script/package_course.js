$(function () {
    ...
    $('.package_course_details').on('click', function () {
        var course_title = $(this).attr('data-title');
        var description = $(this).attr('data-description');
        var course_code = $(this).attr('data-code');
        var credit_unit = $(this).attr('data-credit_unit');
        var subject = $(this).attr('data-subject');
        var course_duration = $(this).attr('data-course_duration');
        var courselecture_name = $(this).attr('data-lecturer_id');
        $('#course_title_fetch').html(course_title);
        $('#course_description_fetch').html(description);
        $('#course_course_code_fetch').html(course_code);
        $('#course_credit_unit_fetch').html(credit_unit);
        $('#course_subject_fetch').html(subject);
        $('#course_course_duration_fetch').html(course_duration);
        $('#course_courselecture_name_fetch').html(courselecture_name);
    });
